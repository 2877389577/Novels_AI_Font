...
## 自动记忆
项目级 auto-memory 已记录鉴权设计在 `C:\Users\Administrator\.claude\projects\D--projects-font-Novels-AI-Font\memory\`。会话结束前如学到新的项目级事实（接口契约、设计约定、踩坑根因），按 auto memory 规则更新。
